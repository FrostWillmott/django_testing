...
def test_pages_availability_for_different_users(
    ...
    ), f"Страница {name_url} вернула статус код {response.status_code} для {parametrized_client}, а ожидался статус {expected_status}"
...
def test_redirects(client, name_url, user_login_url):
    ...
    ), f"Страница {name_url} не перенаправила анонимного пользователя на струницу {expected_url}"
